...
data_root = r"C:\Users\iannb\OneDrive\Documents\BC Senior Year_\Speech Sig\ProblemSets\ps3-ib173\data\*.TextGrid"
file_path = r"C:\Users\iannb\OneDrive\Documents\BC Senior Year_\Speech Sig\ProblemSets\ps3-ib173\Conversion Outputs"
...
if __name__=="__main__":
    ...
    for tg in glob.glob(data_root):
        ...
        # textgrid.toJson()
        # print(textgrid.toJson())
        with open(file_path + str(count) + ".json", "wb") as file:
            file.write(textgrid.toJson())
        count += 1
