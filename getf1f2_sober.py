...
# list to store sober features
sober = []
counter = 0 

# for each .wav file
for wav_file in glob.glob(join(FILEPATH, "\chunked_audio_files_sober/*.wav")):
    ...
    # append all the features to the sober data 
    sober.append(results)
